...
param authApplicationClientSecretName string = 'MICROSOFT_PROVIDER_AUTHENTICATION_SECRET'

// Runtime Properties
@allowed([
  'dotnet-isolated', 'node', 'python', 'java', 'powershell', 'custom', 'dotnet'
])
    ...
    properties: union(appSettings,
      {
        ...
        authApplicationClientSecretName: identityClientId
      })
  }
      ...
      identityProviders: {
        azureActiveDirectory: {
          ...
          registration: {
            ...
            clientSecretSettingName: authApplicationClientSecretName
          }
          validation: {
            allowedAudiences: [
