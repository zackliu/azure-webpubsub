...
var functionAppName = !empty(apiServiceName) ? apiServiceName : '${abbrs.webSitesFunctions}sioserverless-${resourceToken}'
...
module federatedApplication './core/identity/federatedIdentity.bicep' = {
  ...
  params: {
    ...
    federatedIdentityObjectId: apiUserAssignedIdentity.outputs.identityPrincipalId
  }
}
...
module api './app/api.bicep' = {
  ...
  params: {
    ...
    socketIOEndpoint: 'https://chenylsioserverless3.webpubsub.azure.com'
